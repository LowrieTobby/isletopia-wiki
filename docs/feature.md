...
::: tip 正版用户
对于正版用户，你可以放心更改自己的ID。服务器底层采用UUID鉴别玩家身份，更换ID后仍然保留所有数据。
:::
...
为了杜绝玩家恶意制造卡服机或其他挤占浪费服务器资源的情况。服务器推出了水电缴费系统，该系统不会限制正常玩家的红石机器与刷怪塔等。制造优化不佳的红石机器可能会受到此系统的限制，玩家们应当自行注意机器优化与合理建造。如果你的岛屿正常机器受到了限制，请联系管理员予以解除。

::: details 水电计费是否会影响到新人的发展？是否会影响红石使用？

水电系统出现的目的是为了杜绝恶意卡服行为，并鼓励玩家优化机器，降低对服务端性能的影响。经过一段时间的测试和实验，水电系统赠送的额度远远超出新人所需，不会影响玩家正常发育。对于后期玩家，玩家应当将大型机器分散多个岛屿，对于每个岛屿而言，赠送的额度同样能够满足需求。
所以水电计费也不会影响后期玩家的红石使用。

:::


该系统会记录玩家岛屿上红石、漏斗、活塞、发射器、矿车、TNT等使用次数，并产生电费水费消耗。
...
指令`/waterbar`和`/powerbar`可查看当前岛屿水费或电费的状态条。再次输入关闭状态条。
:::


当玩家剩余电费或水费为负数时，所有方块将不更新红石信号，水流不再更新。

计费系统每周重置，每周会赠送一定电费和水费，玩家在线也会赠送水电费。 通常情况下**玩家无需缴纳任何水电费**。如果岛屿欠费，请首先留意自己的岛屿是否存在大量无意义机器。

水电系统每周会赠送10,000度电和10,000吨水。玩家每在线1分钟，该岛屿则会被赠送100度电和100吨水，岛上每个激活的潮涌核心和信标都会额外提供10度水或电。 此外每晚00:00 ~ 08:00停止计费，鼓励玩家在闲时开放机器工作。

水电费使用钻石缴纳，采用梯度用电制度，每次购买给予10,000度电或10,000吨水，购买价格随着购买次数线性增加。

::: details 为什么水和电分开计算？

我们注意到，部分玩家采用高频发射流水的方式制作刷怪塔、守卫者塔、墨鱼塔，并且使用了较快的脉冲。
高频发射流水不仅会大幅度增加服务器压力，也会让客户端FPS大幅度降低。
经过研究发现，存在较多的替代方案，可以降低发射流水的频率并达到同样的刷怪效率。
所以，服务器鼓励大家降低高频水流的使用。将水流独立出来，让大家更好地意识到，水流对客户端与服务端性能造成的影响。
